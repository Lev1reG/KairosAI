...
const RegisterPage = () => {
  return (
    <>
      <Navbar>
      <button className="px-4 py-1 rounded-full bg-gray-200 mr-4" style={{color: "#757575"}}>Login</button>
      <button className="px-4 py-1 rounded-full text-white" style={{backgroundColor: "#143A52"}}>Register</button>
      </Navbar>
      <div className="flex items-center justify-center min-h-screen bg-gray-50 py-12">
        <div className="bg-white p-20 rounded-2xl shadow-lg w-full max-w-2xl h-150 space-y-6 py-25">
          ...
          <form className="space-y-4 ">
            ...
            <InputField icon={<Lock size={18} />} placeholder="Confirm Password" type="password" />

            <button className="w-full py-2 rounded-full text-black font-medium cursor-pointer" style={{backgroundColor: "#A3C6C4"}}>Register</button>
          ...
          <p className="text-center my-4">
            ...
            <Link to="/auth/login" className="font-semibold cursor-pointer text-gray-700 hover:underline">Login</Link>
          </p>
        </div>
      </div>
    </>
